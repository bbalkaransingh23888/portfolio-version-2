...
const url = 'https://v1.nocodeapi.com/lonewolf23/google_sheets/AgIhNmrlkMBTvApZ?tabId=Sheet1'
...
// CSS jQuery
$('body').css('background-color','#C0C0C0').css('color','black').css('font-family', "'Old Standard TT', serif").css('padding','0').css('margin','0').css('height','0').css('position','relative');
$h1.css('color', '#c21807').css('font-size', '65px').css('background-color', 'black').css('border', '5px solid gold').css('text-align', 'center').css('font-family', "'Play', sans-serif");
$('h2').css('font-style',"'Play', sans-serif");
$('h3').css('font-style',"'Play', sans-serif");
$('h4').css('font-style',"'Play', sans-serif");
